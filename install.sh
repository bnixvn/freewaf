...
UPDATE_REPO_URL="${FREEWAF_UPDATE_REPO_URL:-$(read_existing_env FREEWAF_UPDATE_REPO_URL https://github.com/bnixvn/freewaf.git)}"
UPDATE_BRANCH="${FREEWAF_UPDATE_BRANCH:-$(read_existing_env FREEWAF_UPDATE_BRANCH main)}"
UPDATE_RESTART_CMD="${FREEWAF_UPDATE_RESTART_CMD:-$(read_existing_env FREEWAF_UPDATE_RESTART_CMD 'systemctl restart freewaf')}"
...
DASHBOARD_STATE_REFRESH_SECONDS=15
FREEWAF_LOG_TAIL_MIN_ENTRIES=1000
FREEWAF_LOG_TAIL_MAX_ENTRIES=10000
FREEWAF_LOG_TAIL_MAX_BYTES=16777216
FREEWAF_UPDATE_REPO_URL=${UPDATE_REPO_URL}
FREEWAF_UPDATE_BRANCH=${UPDATE_BRANCH}
FREEWAF_UPDATE_RESTART_CMD="${UPDATE_RESTART_CMD}"

...
SAFELINE_COMPATIBILITY_RULES = [
    ...
    _safeline_rule(65720, "Code Injection vulnerability (against WordPress)", r"(?:/wp-admin/admin-ajax\.php|/wp-json/.*(?:wp/v2|wc/)|/wp-content/plugins/[^?]+/(?:ajax|upload|download)|(?:action|cmd|exec)=.*(?:assert|eval|system))", target="all", severity="critical"),
